...
angular.module('CoreApi', ['CoreApiUtilities'])
     ...
     this.getNotification = function(bodyParams, device , companyId) {
        var config = httpService.Utils.getHeader();
        var url = httpService.Utils.buildUrl(new Array('api', 'notification','push','send',device, companyId));
        ...
        .service('Appointment', ['httpService', function (httpService) {
                ...
                this.getServices = function (branchId) {
                    var config = httpService.Utils.getHeader();
                    var url = httpService.Utils.buildUrl(new Array('api', 'branch', branchId, 'services'));
                ...
                this.getAnnualHolidayDays = function() {
                        var config = httpService.Utils.getHeader();
                        var url = httpService.Utils.buildUrl(new Array('api', 'annualholiday '));
                        console.log("Annual Holiday URL" , url);
                        return httpService.$http.get(url, config);
                }

                this.getAppointmentStartDate = function(startDate, endDate) {
                        var config = httpService.Utils.getHeader();
                        var url = httpService.Utils.buildUrl(new Array('api', 'appointments', startDate, endDate));
                        return httpService.$http.get(url, config);
                }
