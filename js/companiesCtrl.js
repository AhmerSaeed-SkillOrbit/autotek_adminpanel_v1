app.controller('companiesCtrl', function($state, $scope, User, $http) {
        ...
        $scope.registerCompany = function() {
                ...
                if ($scope.addCompany.NameEn == null || $scope.addCompany.NameEn == "") {
                    errors.push({ message: 'Name (En) is required' })
                }

                if ($scope.addCompany.NameAr == null || $scope.addCompany.NameAr == "") {
                    errors.push({ message: 'Name (Ar) is required' })
                }

                if ($scope.addCompany.Contact == null || $scope.addCompany.Contact == "") {
                    errors.push({ message: 'Contact Number is required' })
                }

                if ($scope.addCompany.Address == null || $scope.addCompany.Address == "") {
                ...
                if ($scope.addCompany.ContactPhone == null || $scope.addCompany.ContactPhone == "") {
                    errors.push({ message: 'Contact Phone is required' })
                }
                ...
                if ($scope.addCompany.SecondaryContactPerson == null || $scope.addCompany.SecondaryContactPerson == "") {
                    errors.push({ message: 'Secondary Contact is required' })
                }

                if ($scope.addCompany.ContactPhone1 == null || $scope.addCompany.ContactPhone1 == "") {
                ...
                if ($scope.addCompany.BankDetails == null || $scope.addCompany.BankDetails == "") {
                    errors.push({ message: 'Bank Detail is required' })
                }

                if ($scope.addCompany.OtherPaymentMethods == null || $scope.addCompany.OtherPaymentMethods == "") {
                    errors.push({ message: 'Other Payment Methods is required' })
                }

                if ($scope.addCompany.CompanyCommission == null || $scope.addCompany.CompanyCommission == "") {
                    errors.push({ message: 'Company Commission is required' })
                }

                if ($scope.addCompany.CompanyStatus == null || $scope.addCompany.CompanyStatus == "") {
                    errors.push({ message: 'Status is required' })
                }

                if ($scope.addCompany.CompanyErpRerence == null || $scope.addCompany.CompanyErpRerence == "") {
